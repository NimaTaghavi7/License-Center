      ...
      <div className="mx-auto flex  min-h-22.5 w-full max-w-[1600px] flex-wrap items-center justify-center gap-4 px-3 py-4 sm:gap-5 sm:px-5 lg:min-h-30 lg:justify-between lg:px-8">
        <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3 lg:gap-5">
          ...
          <NavigationMenu dir="rtl" className="z-50">
            <NavigationMenuList className="flex flex-wrap items-center justify-center gap-1 sm:gap-2">
              <NavigationMenuItem>
                <NavigationMenuLink href="/" className="inline-flex h-10 items-center justify-center rounded-full px-4 text-sm font-bold text-white transition-colors hover:bg-[#ef394e] focus:bg-[#ef394e] focus:outline-none">
                  خانه
                </NavigationMenuLink>
              </NavigationMenuItem>
                ...
                <NavigationMenuContent className="w-[min(1250px,calc(100vw-24px))] rounded-2xl border border-white/10 bg-[#12121d] p-4 text-white shadow-2xl sm:p-5 lg:p-6">
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5 lg:gap-5">
                    {serviceColumns.map((column) => (
                      <div key={column.title} className="min-w-0 border-b border-white/10 pb-4 last:border-b-0 sm:border-b-0 sm:pb-0">
                        <NavigationMenuLink href={column.href} className="mb-2 block rounded-lg px-3 py-2 text-right text-sm font-extrabold leading-6 text-white transition-colors hover:bg-white/5 hover:text-[#ef394e] focus:bg-white/5 focus:text-[#ef394e] focus:outline-none">
                          {column.title}
                        </NavigationMenuLink>

                        <div className="flex flex-col gap-0.5">
                          {column.items.map((item) => (
                            <NavigationMenuLink key={item.title} href={item.href} className="block rounded-lg px-3 py-2 text-right text-sm font-medium leading-6 text-white/70 transition-all hover:bg-[#ef394e]/10 hover:pr-4 hover:text-[#ef394e] focus:bg-[#ef394e]/10 focus:text-[#ef394e] focus:outline-none">
                              {item.title}
                            </NavigationMenuLink>
                          ))}
                        </div>
              ...
              <NavigationMenuItem>
                <NavigationMenuLink href="/blog" className="inline-flex h-10 items-center justify-center rounded-full px-4 text-sm font-bold text-white transition-colors hover:bg-[#ef394e] focus:bg-[#ef394e] focus:outline-none">
                  وبلاگ
                </NavigationMenuLink>
              </NavigationMenuItem>
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-5 lg:gap-6">
          <div className="flex items-center gap-2 sm:gap-3">
            <a href="/search" aria-label="جستجو" className="flex h-10 w-10 items-center justify-center rounded-full text-white transition-colors hover:bg-[#ef394e] focus:bg-[#ef394e] focus:outline-none">
              <Search className="h-5 w-5" />
            </a>

            <a href="/cart" aria-label="سبد خرید" className="flex h-10 w-10 items-center justify-center rounded-full text-white transition-colors hover:bg-[#ef394e] focus:bg-[#ef394e] focus:outline-none">
              <ShoppingCart className="h-5 w-5" />
            </a>
          </div>

          <div className="flex items-center gap-2 text-sm sm:gap-3">
            <a href="/register" className="rounded-full px-3 py-2 text-white transition-colors hover:bg-[#ef394e] focus:bg-[#ef394e] focus:outline-none">
              عضویت
            </a>

            <span className="text-white/40">|</span>

            <a href="/login" className="rounded-full px-3 py-2 text-white transition-colors hover:bg-[#ef394e] focus:bg-[#ef394e] focus:outline-none">
              وارد شوید
            </a>
          </div>
        </div>
